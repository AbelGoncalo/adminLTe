...
class ServicoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'porcentagem'=> ['required', 'integer', 'between:0,100'],

            'valor_quarto'=> ['required', 'numeric', 'min:0'],
            'horas_quarto'=> ['required', 'integer', 'min:0'],

            'valor_sala'=> ['required', 'numeric', 'min:0'],
            'horas_sala'=> ['required', 'integer', 'min:0'],

            'valor_banheiro'=> ['required', 'numeric', 'min:0'],
            'horas_banheiro'=> ['required', 'integer', 'min:0'],

            'valor_cozinha'=> ['required', 'numeric', 'min:0'],
            'horas_cozinha'=> ['required', 'integer', 'min:0'],

            'valor_quintal'=> ['required', 'numeric', 'min:0'],
            'horas_quintal'=> ['required', 'integer', 'min:0'],

            'valor_outros'=> ['required', 'numeric', 'min:0'],
            'horas_outros'=> ['required', 'integer', 'min:0'],
